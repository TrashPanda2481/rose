...
Verified on BIOS+UEFI QEMU, zero build warnings, all self-test steps pass including both new Map steps, no page fault. Not yet confirmed in Oracle VM VirtualBox, where the original crash was seen. Not promoted to `stable`.
